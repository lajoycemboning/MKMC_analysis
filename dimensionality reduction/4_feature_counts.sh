...
for sample in "${samples[@]}"; do
    ...
    echo "featureCounts -T $threads -p -a /home/lajoyce/mkmc/liver/trimmed_reads/GFF/nfur/ref_Nfu_20140520_top_level_filtered.gtf -g gene_name -o ${feature_counts_output}/${sample}/${sample}.featureCounts ${uniquely_mapped_reads}/${sample}/${sample}_UniquelyMapped.bam"
